...
# True values from Jacques 2013 / Meglinski-Matcher model (unscaled);
# build_melanin_conditions() applies the epidermis thickness-correction scale
# (0.2 mm physical / 1 mm voxel).
_MELANIN_RAW_650NM = {
    #        µa      µs'    g     n
    'fair':  (0.020, 1.80, 0.80, 1.40),  # Fitzpatrick I-II,   f_mel ~1.3%
    'olive': (0.070, 1.90, 0.80, 1.40),  # Fitzpatrick III-IV, f_mel ~4.4%
    'dark':  (0.200, 2.00, 0.80, 1.40),  # Fitzpatrick V-VI,   f_mel ~16%
}
...
CONE_ANGLE_DEG    = 30     # source cone full angle
...
def run_subject(subject_id, mesh_dir_base, output_dir, melanin_condition='fair'):
    ...
    tissues = {
        ...
        "pat1-cart":    (mesh_dir / "patella_lig_raw.stl",                10, opt(0.025,  1.80,  0.90, 1.37)),  # fibrocartilage/ligament
        "pat2-cart":    (mesh_dir / "patella_cartilage_raw.stl",          10, opt(0.025,  1.20,  0.90, 1.37)),  # hyaline
